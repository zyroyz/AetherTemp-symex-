...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            menuBackground.GetComponent<Renderer>().material.color = new Color(86f / 255f, 58f / 255f, 235f / 255f);
                ...
                transform =
        {
            ...
            if (disconnectButton)
            {
                ...
                disconnectbutton.GetComponent<Renderer>().material.color = new Color(42f / 255f, 29f / 255f, 119f / 255f);
            ...
            gameObject3.transform.localScale = new Vector3(0.06f, 0.17f, 0.12f);
            gameObject3.transform.localPosition = new Vector3(0.56f, 0f, -0.4f);
            gameObject3.GetComponent<Renderer>().material.color = new Color(42f / 255f, 29f / 255f, 119f / 255f);
            gameObject3.AddComponent<Classes.Button>().relatedText = "home";
            ...
            gameObject.transform.localScale = new Vector3(0.06f, 0.3f, 0.07f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0.3f, -0.4f);
            gameObject.GetComponent<Renderer>().material.color = new Color(42f / 255f, 29f / 255f, 119f / 255f);
                ...
                transform =
        {
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.06f, 0f, -0.155f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
